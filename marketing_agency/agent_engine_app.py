...
from marketing_agency.utils.gcs import create_bucket_if_not_exists
from marketing_agency.utils.tracing import CloudTraceLoggingSpanExporter
from marketing_agency.utils.typing import Feedback
...
def deploy_agent_engine_app(
    ...
    artifacts_bucket_name = f"{project}-marketing-agent-logs-data"
